...
# PHP 8.5 User-defined Volumes
#
# Aggiungi qui i volumi per montare le tue applicazioni nel container php85.
...
#
# Dopo ogni modifica: docker compose up -d --force-recreate php85

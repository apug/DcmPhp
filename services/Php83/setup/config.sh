...
# PHP 8.3 User-defined Volumes
#
# Aggiungi qui i volumi per montare le tue applicazioni nel container php83.
...
#
# Dopo ogni modifica: docker compose up -d --force-recreate php83

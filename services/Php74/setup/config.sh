...
# PHP 7.4 User-defined Volumes
#
# Aggiungi qui i volumi per montare le tue applicazioni nel container php74.
...
#
# Dopo ogni modifica: docker compose up -d --force-recreate php74
